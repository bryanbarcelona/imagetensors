...
class OibImageReader(BaseImageReader):
    ...
    def read(self) -> Iterator[ImageData]:
        ...
        axis_info = {
            mainfile["Axis 0 Parameters Common"]["AxisCode"]: 
                mainfile["Axis 0 Parameters Common"]["MaxSize"],
            mainfile["Axis 1 Parameters Common"]["AxisCode"]: 
                mainfile["Axis 1 Parameters Common"]["MaxSize"],
            mainfile["Axis 2 Parameters Common"]["AxisCode"]: 
                mainfile["Axis 2 Parameters Common"]["MaxSize"],
            mainfile["Axis 3 Parameters Common"]["AxisCode"]: 
                mainfile["Axis 3 Parameters Common"]["MaxSize"],
            mainfile["Axis 4 Parameters Common"]["AxisCode"]: 
                mainfile["Axis 4 Parameters Common"]["MaxSize"],
        }
        ...
        for dim_idx, dim_code in enumerate("CZTYX"):
            if array.shape[dim_idx] != axis_info.get(dim_code, 1):
                if axis_info.get(dim_code, 1) == 0:
